...
<head>
    ...
    <title>All Payments - Prime Cargo Limited</title>
    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="d-flex gap-2">
                <a href="admin_payments.php" class="btn btn-outline-secondary btn-sm <?php echo $status === '' ? 'active' : ''; ?>">All</a>
                <a href="admin_payments.php?status=completed" class="btn btn-outline-success btn-sm <?php echo $status === 'completed' ? 'active' : ''; ?>">Completed</a>
                <a href="admin_payments.php?status=pending" class="btn btn-outline-warning btn-sm <?php echo $status === 'pending' ? 'active' : ''; ?>">Pending</a>
                <a href="admin_payments.php?status=failed" class="btn btn-outline-danger btn-sm <?php echo $status === 'failed' ? 'active' : ''; ?>">Failed</a>
            </div>
        </div>
